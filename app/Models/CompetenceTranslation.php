...
use Database\Factories\CompetenceTranslationFactory;
 ...
 * @property int $order
 * @property CompetenceStatus $status
 ...
 * @property-read Competence $competence
 ...
 * @mixin Builder
 *
 * @extends Model<CompetenceTranslationFactory>
 */
class CompetenceTranslation extends Model
{
    /** @use HasFactory<CompetenceTranslationFactory> */
    ...
    /**
     * Get all the tags for the CompetenceTranslation
     */
