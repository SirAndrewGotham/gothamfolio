...
return [
    ...
    'frontend' => [
        ...
        'galleries' => [
            'index' => [
                'page-title' => 'Photogalleries',
                'breadcrumb-title' => 'Galleries',
                'no-gallery-found' => 'No galleries on the site yet.',
            ],
            'show' => [
                'page-title' => 'Gallery',
                'breadcrumb-title' => 'Gallery',
                'recent-gallery' => 'New galleries',
            ],
            'tag' => [
                'page-title' => 'Galleries - all galleries tagged with ":tag_name"',
                'breadcrumb-title' => 'Gallery',
                'no-gallery-found' => 'No galleries with the tag requested.',
            ],
        ],
    ],
    'blocks' => [
